...
for (const [framework] of __VLS_vFor((__VLS_ctx.frameworks))) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.article, __VLS_intrinsics.article)({
        key: (framework.name),
        ...{ class: "framework-card group rounded-xl border border-white/9 p-5 transition-colors duration-300 hover:border-white/18" },
    });
    /** @type {__VLS_StyleScopedClasses['framework-card']} */ ;
    /** @type {__VLS_StyleScopedClasses['group']} */ ;
    /** @type {__VLS_StyleScopedClasses['rounded-xl']} */ ;
    /** @type {__VLS_StyleScopedClasses['border']} */ ;
    /** @type {__VLS_StyleScopedClasses['border-white/9']} */ ;
    /** @type {__VLS_StyleScopedClasses['p-5']} */ ;
    /** @type {__VLS_StyleScopedClasses['transition-colors']} */ ;
    /** @type {__VLS_StyleScopedClasses['duration-300']} */ ;
    /** @type {__VLS_StyleScopedClasses['hover:border-white/18']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    id: "quickstart",
    ...{ class: "quickstart-panel relative mt-28 overflow-hidden rounded-3xl border border-white/10 bg-panel px-6 py-16 text-center sm:px-12 sm:py-22" },
});
/** @type {__VLS_StyleScopedClasses['quickstart-panel']} */ ;
/** @type {__VLS_StyleScopedClasses['relative']} */ ;
...
/** @type {__VLS_StyleScopedClasses['text-center']} */ ;
/** @type {__VLS_StyleScopedClasses['sm:px-12']} */ ;
/** @type {__VLS_StyleScopedClasses['sm:py-22']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div)({
    ...{ class: "absolute inset-0 [background:radial-gradient(circle_at_50%_0%,rgba(33,149,237,.20),transparent_44%)]" },
});
/** @type {__VLS_StyleScopedClasses['absolute']} */ ;
/** @type {__VLS_StyleScopedClasses['inset-0']} */ ;
/** @type {__VLS_StyleScopedClasses['[background:radial-gradient(circle_at_50%_0%,rgba(33,149,237,.20),transparent_44%)]']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.div)({
...
/** @type {__VLS_StyleScopedClasses['border']} */ ;
/** @type {__VLS_StyleScopedClasses['border-white/10']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-[#061018]']} */ ;
...
/** @type {__VLS_StyleScopedClasses['bg-[#ff6b6b]']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.span)({
    ...{ class: "size-2 rounded-full bg-[#ffd166]" },
});
/** @type {__VLS_StyleScopedClasses['size-2']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded-full']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-[#ffd166]']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.span)({
    ...{ class: "size-2 rounded-full bg-[#42d392]" },
});
/** @type {__VLS_StyleScopedClasses['size-2']} */ ;
/** @type {__VLS_StyleScopedClasses['rounded-full']} */ ;
/** @type {__VLS_StyleScopedClasses['bg-[#42d392]']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
...
for (const [line, index] of __VLS_vFor((__VLS_ctx.installLines))) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        key: (line.text),
